...
// Aprovechando que zod ya esta instalado lo usamos para hacer validaciones
// Con esto no tenemos que validar con muchas expreciones regulares.
...
export const createUpdateProduct = async (formData: FormData) => {
	...
	try {
		const prismaTx = await prisma.$transaction(async (tx) => {
			...
			const parsedSizes = rest.sizes as Size[];
